...
Spectrum next_event_estimation(Vector3 p, int current_medium_id, const Scene &scene, Vector3 dir_in, int bounces, pcg32_state &rng) {
...
Spectrum vol_path_tracing_4(const Scene &scene,
    ...
    while (true) {
        ...
        if (scatter) {
            ...
            std::optional<Vector3> next_dir_ = sample_phase_function(phase_function, -ray.dir, rnd_param);
            // NEE
            Spectrum nee_res = next_event_estimation(ray.org, current_medium_id, scene, -ray.dir, bounces, rng);
